...
import SelectEventView from "./pages/selectEventView/SelectEventView";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/selectevent/:id" element={<SelectEventView/>}></Route>
        <Route path="/selectevent/registerattendee/:id" element={<RegisterAttendee />}></Route>
      </Routes>
    </BrowserRouter>
  );
}
